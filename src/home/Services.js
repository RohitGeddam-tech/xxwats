        ...
        <>
            <div className='desktop'>
                ...
                <div className='service-container'>
                    <div className='tabs'>
                        <div className='sentence' data-aos="fade-right" data-aos-duration="2900">
                        ...
                        <div className='picture' data-aos="fade-left" data-aos-duration="2900">
                            <img src={strategy} alt='strategy.png' />
                        </div>
                    </div>
                    <div className='tabs'>
                        <div className='picture' data-aos="fade-right" data-aos-duration="2900">
                            <img src={creative} alt='creative.png' />
                        </div>
                        <div className='sentence' data-aos="fade-left" data-aos-duration="2900">
            ...
            <div className='desktop'>
                ...
                <div className='service-container'>
                    <div className='mobtabs'>
                        <div className='mob-sentence' data-aos="fade-right" data-aos-duration="2900">
                        ...
                        <div className='mob-pic' data-aos="fade-left" data-aos-duration="2900">
                            <img src={strategy} alt='strategy.png' />
                        </div>
                    </div>
                    <div className='mobtabs'>
