    ...
    return (
        <>
            <div className='mobbox'>
                ...
                <div className='mobmid-container'>
                    <div className='mobfirst'>
                        <img src={savio} alt='cyril' data-aos="zoom-in" data-aos-duration="2000" />
                        <div data-aos="flip-down" data-aos-duration="3000">
                        <h4>Savio</h4>
                        <p>
                ...
                <div className='mobmid-container'>
                    <h4>Creative Team</h4>
                    <div className='mobfirst'>
                        <img src={arathi} alt='cyril' data-aos="zoom-in" data-aos-duration="2000" />
                        <div data-aos="flip-down" data-aos-duration="3000">
                        <h4>Arathi</h4>
                        <p>
                ...
                <div className='mobmid-container'>
                    <div className='mobfirst'>
                        <img src={ansh} alt='cyril' data-aos="zoom-in" data-aos-duration="2000" />
                        <div data-aos="flip-down" data-aos-duration="3000">
                        <h4>Ansh</h4>
                        <p>
                ...
                <div className='mobmid-container'>
                    <h4>Business Team</h4>
                    <div className='mobfirst'>
                        <img src={anushree} alt='cyril' data-aos="zoom-in" data-aos-duration="2000" />
                        <div data-aos="flip-down" data-aos-duration="3000">
                        <h4>Anushree</h4>
                        <p>
                ...
                <div className='mobmid-container'>
                    <div className='mobfirst'>
                        <img src={saloni} alt='cyril' data-aos="zoom-in" data-aos-duration="2000" />
                        <div data-aos="flip-down" data-aos-duration="3000">
                        <h4>Saloni</h4>
                        <p>
                ...
                <div className='mobmid-container' data-aos="zoom-in" data-aos-duration="2000">
                    <h4>Production team</h4>
                    <div className='mobfirst' data-aos="flip-down" data-aos-duration="3000">
                        <p>
